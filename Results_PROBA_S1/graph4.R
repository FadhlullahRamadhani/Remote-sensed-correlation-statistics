...
charts.data$keckab <- paste0(charts.data$KECAMATAN,"/ ",charts.data$KABUPATEN)
charts.data$keckab2 <- paste0(charts.data$KECAMATAN,"-",charts.data$KABUPATEN)
...
cols_Phase2 <- c("Paddy_planting" = "#66cc00", "VEG" = "#66cc00","Paddy_harvested" = "#ffcc00", "RIPE" = "#ffcc00")
cols_Phase2_line <- c("Paddy_planting" = 1, "VEG" = 4,"Paddy_harvested" = 1, "RIPE" = 4)
cols_Phase2_point <- c("Paddy_planting" = 16, "VEG" = 16,"Paddy_harvested" = 17, "RIPE" = 17)
...
p2 <- ggplot(data = charts.data.regency.plot2, 
             mapping = aes(x = date, y = value, color = variable, linetype = variable, shape= variable)) +
  geom_line(size=1) +
  geom_point() +
  xlab("Date") +
  ylab("Area (ha)") + 
  ...
  facet_wrap(vars(KABUPATEN),  ncol=1) +
  theme_bw() + 
  scale_shape_manual(name="Legend", values = cols_Phase2_point,breaks=c("Paddy_planting","VEG","Paddy_harvested","RIPE"),labels = c("Paddy planting area (Local statistics)","Vegetative area (Remote sensing)","Paddy harvested  area (Local statistics)","Ripening (Remote sensing)")) +
  scale_linetype_manual(name="Legend", values = cols_Phase2_line,breaks=c("Paddy_planting","VEG","Paddy_harvested","RIPE"),labels = c("Paddy planting area (Local statistics)","Vegetative area (Remote sensing)","Paddy harvested  area (Local statistics)","Ripening (Remote sensing)")) +
  scale_colour_manual(name="Legend", values = cols_Phase2,breaks=c("Paddy_planting","VEG","Paddy_harvested","RIPE"),labels = c("Paddy planting area (Local statistics)","Vegetative area (Remote sensing)","Paddy harvested  area (Local statistics)","Ripening (Remote sensing)")) +
...
charts.data_SD <- filter(charts.data, area_RS > 7000)
...
p4 <- ggplot(data = charts.data.regency.plot4, 
             mapping = aes(x = date, y = value, color = variable, linetype = variable)) +
  geom_line(size=0.7) +
  geom_point() +
  xlab("Date") +
  ylab("Area (ha)") + 
...
for (i in 1:length(listkabkec)) {
  ...
  charts.data_SD_plot1 <- cbind(charts.data_SD$keckab,charts.data_SD$tanggal,"Vegetative-Ripening (Remote sensing)","VEG",charts.data_SD$VEG)
  charts.data_SD_plot2 <- cbind(charts.data_SD$keckab,charts.data_SD$tanggal,"Vegetative-Ripening (Remote sensing)","RIPE",charts.data_SD$RIPE)
  charts.data_SD_plot3 <- cbind(charts.data_SD$keckab,charts.data_SD$tanggal,"Ripening (Remote sensing)-Harvested (Local statistics)","RIPE",charts.data_SD$RIPE)
  charts.data_SD_plot4 <- cbind(charts.data_SD$keckab,charts.data_SD$tanggal,"Ripening (Remote sensing)-Harvested (Local statistics)","Paddy_harvested",charts.data_SD$Paddy_harvested)
  charts.data_SD_plot5 <- cbind(charts.data_SD$keckab,charts.data_SD$tanggal,"Planting-Harvested (Local statistics)","Paddy_planting",charts.data_SD$Paddy_planting)
  charts.data_SD_plot6 <- cbind(charts.data_SD$keckab,charts.data_SD$tanggal,"Planting-Harvested (Local statistics)","Paddy_harvested",charts.data_SD$Paddy_harvested)
  charts.data_SD_plot7 <- cbind(charts.data_SD$keckab,charts.data_SD$tanggal,"Vegetative (Remote sensing)-Planting","VEG",charts.data_SD$VEG)
  charts.data_SD_plot8 <- cbind(charts.data_SD$keckab,charts.data_SD$tanggal,"Vegetative (Remote sensing)-Planting","Paddy_planting",charts.data_SD$Paddy_planting)
