...
mainDir_results<- paste("C:/MasseyOffice1/Research/R-Script2019/",sep="")
...
write.csv(results, file =  paste("C:/Users/framadha/Google Drive/recap_stats_SENSOR_S1_PROBA_v1.csv",sep=""))
